  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 leading-relaxed">
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-green-100 p-8 rounded-xl shadow">
            <h3 className="text-xl font-semibold mb-3 text-green-800">Our Mission</h3>
      ...
      <section className="py-16 px-6 bg-gray-100">
        <h2 className="text-2xl font-semibold text-center mb-10">Our Impact</h2>
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8 text-center">

          <div className="bg-white p-8 shadow rounded-xl">
            <h3 className="text-3xl font-bold text-green-700">500+</h3>
            <p className="mt-2 text-gray-600 text-sm">Users Educated</p>
          </div>

          <div className="bg-white p-8 shadow rounded-xl">
            <h3 className="text-3xl font-bold text-blue-700">120+</h3>
            <p className="mt-2 text-gray-600 text-sm">Pickups Completed</p>
          </div>

          <div className="bg-white p-8 shadow rounded-xl">
            <h3 className="text-3xl font-bold text-yellow-600">80+</h3>
            <p className="mt-2 text-gray-600 text-sm">Composting Experts</p>
          </div>

          <div className="bg-white p-8 shadow rounded-xl">
            <h3 className="text-3xl font-bold text-red-600">95%</h3>
            <p className="mt-2 text-gray-600 text-sm">Positive Feedback</p>
          </div>
      ...
      <section className="max-w-6xl mx-auto py-16 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-white shadow p-6 rounded-xl text-center">
            ...
            <h4 className="text-lg font-bold">Yukta Shree</h4>
            <p className="text-gray-600 text-sm">Founder & Eco Advocate</p>
          </div>

          <div className="bg-white shadow p-6 rounded-xl text-center">
            <div className="w-24 h-24 mx-auto bg-gray-300 rounded-full mb-4"></div>
            <h4 className="text-lg font-bold">Priyanshu Singh</h4>
            <p className="text-gray-600 text-sm">Waste Management Expert</p>
          </div>

          <div className="bg-white shadow p-6 rounded-xl text-center">
            <div className="w-24 h-24 mx-auto bg-gray-300 rounded-full mb-4"></div>
            <h4 className="text-lg font-bold">Soham Ghosh</h4>
